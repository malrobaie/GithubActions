[![Run App MohammadAlrobaie](https://github.com/malrobaie/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/malrobaie/GithubActions/actions/workflows/run-app.yaml)
